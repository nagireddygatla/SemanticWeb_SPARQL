...
@WebServlet("/ptclassify")
public class Ptclassify extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    try {
    	...
    	String queryString = prefix + "SELECT ?name WHERE { ?element table:name ?name; table:classification table:"+pclass+".} ";        
      ...
      try {
        ...
        out.println("<h3>Elements in "+pclass+"</h3>");
        while(rs.hasNext()){
