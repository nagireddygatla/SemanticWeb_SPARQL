...
@WebServlet("/ptgroup")
public class Ptgroup extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    try {
    	...
    	String queryString = prefix + "SELECT ?name WHERE { ?element table:name ?name; table:group table:"+gno+".} ";        
      ...
      try {
        ...
        out.println("<h3>Elements in "+gno+"</h3>");
        while(rs.hasNext()){
