...
@WebServlet("/ptstate")
public class Ptstate extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    try {
    	...
    	String queryString = prefix + "SELECT ?name WHERE { ?element table:name ?name; table:standardState table:"+pstate+".} ";        
      ...
      try {
        ...
        out.println("<h3>Elements in "+pstate+"</h3>");
        while(rs.hasNext()){
